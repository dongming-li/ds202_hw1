...
3. Write a paragraph to introduce yourself. Set your name in bold font and your major in italic. 
    ...
    Answer: My name is **Dongming Li**. I am an international student from China. My major is *Computer Science*, and     *Data Science* is my minor. I choose these two majors because I like playing games and I hope to become a game        developer in the future. Moreover, I am interested in mathematics and like to analyze data. 
...
4. Write a paragraph describing a job that you think is related to data science. Include a hyperlink and an image. Make sure your answer is in a nice format to read. 
    ...
    Answer: I think [Market analyst](https://neuvoo.ca/neuvooPedia/en/marketing-analyst/) is a job that related to        data science.Because market analysis requires the collection and analysis of a large number of market data, which     requires the knowledge of data science.
    ![Market Analyst](\Users\dongm\Desktop\ds202_hw1\Market Analyst.jpeg)
  
5. What data topic will you be most interested in? (Optional) Provide a source of such dataset if you have.

    Answer: I am interested in any game-related data. Here is a dataset about [video game sales](https://www.kaggle.com/gregorut/videogamesales?select=vgsales.csv).
